...
function troll() {
    ...
    const y = document.getElementById("fbut3");
      x.style.display="none";
      y.style.display="block";
      document.getElementById("alert").innerHTML = "Chị đừng có từ chối nữa 😙";
      document.getElementById("alert2").innerHTML = "Chị mà thoát trang Web này hay Block e là đồng ý nha 😛";
      document.getElementById("audio2").play();
      return false;
}
function troll1() {
